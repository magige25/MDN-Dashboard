...
const TopCountries = () => {
    ...
    const isMounted = useRef(false); // Flag to prevent double initialization

    useEffect(() => {
        const mapContainer = document.getElementById("map");

        // Prevent double initialization
        if (isMounted.current || !mapContainer) return;

        // Clear existing content to avoid duplicate maps
        ...
        const map = new jsVectorMap({
            ...
            showZoomButtons: true, // Explicitly show zoom buttons
            zoomButtons: {
                position: 'top-left', // Position buttons at top-left (customize as needed)
            },
            hoverColor: '#fff',
        });

        mapRef.current = map; // Store the map instance
        isMounted.current = true; // Mark as initialized
                ...
                <div className="card-body">
                    ...
                    <div className="row gy-4">
                        <div className="col-lg-6">
                            <div id="map" className="h-100 border radius-8" style={{ position: 'relative' }}></div>
                        </div>
                        <div className="col-lg-6">
